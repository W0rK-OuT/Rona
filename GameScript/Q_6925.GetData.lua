...
nTable["check0"] = {
	...
	["lvmin"] = 120,
	["interval"] = 0,
	["quest"] = {{["id"] = 6924, ["state"] = 1}},
	["item"] = {{["id"] = 4031514}, {["id"] = 4031515}},
	["job"] = {311, 321},
}
nTable["check1"] = {
	["npc"] = 2081000,
...
nTable["info"] = {
	...
	["1"] = "#b#p2081000##k는 #b#t4031343##k과 #b#t4031344##k을 얻고 싶다면 #b#t4031348##k를 구해다 달라고 했다. 비밀의 주술서는 다른 지역의 주문서 상인들이 알고 있다는데...\r\n#i4031348##t4031348##k #b#c4031348#/1",
