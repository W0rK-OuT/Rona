...
nTable["say1"] = {
	["base"] = {["1"] = "그대는 마법사 레벨 200 달성에 성공하였군! 대단한 업적이오.", ["2"] = "이걸 받으시오."},
