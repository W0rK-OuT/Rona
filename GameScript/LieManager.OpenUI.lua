...
local cgc = self.main.CanvasGroupComponent
local ctweenFunc = function(tweenValue)
	cgc.GroupAlpha = tweenValue
end
_TweenLogic:PlayTween(0, 1, 3, EaseType.Linear, ctweenFunc)
...
_TimerService:SetTimerOnce(func, 2)
