...
nTable["act1"] = {
	...
	["skill"] = {
		{["id"] = 3121004, ["masterLevel"] = 10, ["job"] = {312}}
	},
}
nTable["info"] = {
	["name"] = "보이지 않는 눈으로 쏘는 활",
	["0"] = "전직관인 #b#p2081300##k를 찾아가 보자.",
	["1"] = "#b#p2081300##k는 그의 예전 이야기를 해주며, 수련의 벽에 부딪힌 것 같다면 그가 잃어버린 #b#t4031465##k을 찾아 #b#p1012100##k에게 가 보라고 말했다. 장갑은 켄타우로스가 가지고 있을 거라는데...\n\n#i4031465##t4031465# #b#c4031465#/1",
	["2"] = "#b#p1012100##k는 오래 전에 한 소년에게 주었던 장갑을 기억하고, 새로운 스킬을 가르쳐 주었다. 폭풍처럼 빠르고 강력한 활을 쏠 수 있는 스킬, 폭풍의 시를 얻었다.",
	["area"] = 10,
}
nTable["say0"] = {
	...
	["yes"] = {["1"] = "#b#p1012100##k님을 찾아가 보게. 자네와 같은 경지의 궁수를 가르칠만한 사람은, 역시 그 분 뿐이지. 아차, 그 분은 무척 엄격하셔서 그냥 가면 가르쳐 주시지 않을 거야. 스스로 길을 찾으라 하시겠지. ", ["2"] = "오래 전에 내가 그 분께 받았던 장갑을 잃어버렸는데… 그걸 찾아서 가 보게. 폭풍처럼 빠른 활을 쏘기 위해 연습하느라, 다 낡은 장갑이지만 그렇기에 더 값어치가 있는 물건이지. 아직까지 나를 기억하고 계신다면, 자네에게도 가르침을 주실 거야. ", ["3"] = "장갑은 #r켄타우로스#k들이 가지고 있을 거야. 그 때는 경험이 부족해서 녀석들에게 당했거든. 지금은 상대하는 게 귀찮아서 안 가지만 말이야. "},
...
nTable["say1"] = {
	...
	["yes"] = {["1"] = "당신은 이미 강한 자예요. 스스로의 힘으로도 충분히 길을 찾을 수 있을 것 같지만... 오랜만에 옛 제자를 떠오르게 해 주었으니, 보답으로 한 가지 가르쳐주도록 하죠. ", ["2"] = "흔히 활은 정적인 무기라고 하지요. 하지만 화살에 감겨 휘몰아치는 바람에까지 신경을 집중해 본 일이 있다면, 그런 말은 할 수 없을 거예요. 보는 것은 중요하지 않아요. 바람에 신경을 집중하세요. ", ["3"] = "바람, 그 중에서도 모든 것을 휩쓸어버리는 눈부시게 빠른 폭풍. 마치 폭풍과도 같은, 빠른 활을 쏘는 스킬을 가르쳐 드리죠.  물론 쉽지는 않지만... 당신의 경지라면 그 정도는 되어야 할 거라고 생각해요. ", ["4"] = "당신의 활이 폭풍이 되길..."},
	["stop"] = {
		["0"] = {["answer"] = "1"},
