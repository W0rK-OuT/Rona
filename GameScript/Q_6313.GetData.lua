...
nTable["check0"] = {
	["npc"] = 2012017,
	["quest"] = {{["id"] = 6312, ["state"] = 2}},
	["job"] = {222},
}
nTable["check1"] = {
	["npc"] = 2020005,
	["item"] = {{["id"] = 4031497, ["count"] = 1}},
}
nTable["act0"] = {
	["item"] = {
		{["id"] = 4031497, ["count"] = 1}
...
nTable["say1"] = {
	["base"] = {["1"] = "허허. 소환물이라! 재미있는 이론이로군! 그 #b#p2012017##k란 자, 어떤 마법사인가? 으응? 마법사가 아니라 과학자라고? 어쨌든 재미있군. 좋아. 여기에 역속성의 마법을 부여하면 되는 것 아닌가?", ["2"] = "하지만 단순히 물건에 마법을 부여하는 걸로는 안 돼. 그런 방법으로는 역속성이 된다 해도, 자네의 속성이 가진 힘이 너무 강해서 거기에 눌려버릴 테니 거야. 그래서는 소환물이 제대로 힘을 발휘하지 못하지.", ["3"] = "음, 방법을 생각해 볼 테니, #b#t4031451##k를 이리 주고 잠시 후 다시 말을 걸어 주게나."},
	["stop"] = {
