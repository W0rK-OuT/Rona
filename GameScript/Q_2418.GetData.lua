...
nTable["info"] = {
	...
	["1"] = "수련장의 왕연해에게 스킬을 사용하는 방법을 배우고 있다. 더블 스탭을 사용하여 스텀프를 잡아보자.\r\n\r\n#o130100# #a24181# ( 더블 스탭 사용 )",
	["2"] = "더블 스탭을 사용하여 스텀프를 잡았다.",
	["demandSummary"] = "\r\n",
	["summary"] = "더블 스탭 스킬을 이용하여 스텀프 30마리를 잡자.",
}
nTable["say0"] = {
	["base"] = {["1"] = "이야~고마워. 당신 덕분에 내 표창장을 찾았어. 그럼 이제 수련을 해볼까? 혹시 '스킬'을 모르는 것은 아니겠지? 스킬을 사용하면 조금 더 강한 공격을 할 수 있다네. 어떤가? 도전해보겠나?"},
	["yes"] = {["1"] = "좋아. 더블 스탭을 사용해 스텀프를 30마리만 잡아보게."},
