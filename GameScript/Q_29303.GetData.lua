...
nTable["act1"] = {
	["item"] = {
		{["id"] = 1142012, ["count"] = 1, ["job"] = 16}
	},
}
nTable["info"] = {
	["name"] = "칭호 도전 - 궁극에 다다른 도적",
	["0"] = "#b#e칭호 도전 - 궁극에 다다른 도적#n\n#k명예의 신관 달리어는 궁극에 다다른 자들에게 각기 다른 칭호를 내린다고 한다. 전사는 #e#b투신#k#n, 마법사는 #e#b현자#k#n, 궁수는 #e#b스나이퍼 로드#k#n, 도적은 #e#b레전더리 시프#k#n, 해적은 #e#b해적왕#k#n이 바로 그 칭호들이다. 명예의 신에게 선택받을 자격이 된다면 달리어에게 가서 시험을 받아 보자.",
	["1"] = "#b#e칭호 도전 - 궁극에 다다른 도적#n\n#k\n - 레벨 : #b#jlevel##k / 200",
	["2"] = "#b#e칭호 도전 - 궁극에 다다른 도적#n\n#k\n - 레벨 : #b#jlevel##k / 200\n\n명예의 신관 달리어는 레벨 200을 달성한 나에게 궁극에 다다른 전사 '#b레전더리 시프#k'의 칭호를 부여해주었다. ",
	["area"] = 10,
	["viewMedalItem"] = 1142012,
}
nTable["say0"] = {
	["base"] = {["1"] = "#v1142012# #e#b#t1142012##k\n\n - 도적 레벨 200 달성\n\n#n이 훈장의 주인이 될 자격이 있는지 시험해 보시겠소?"},
...
nTable["say1"] = {
	["base"] = {["1"] = "그대는 도적 레벨 200 달성에 성공하였군! 대단한 업적이오. ", ["2"] = "이걸 받으시오."},
